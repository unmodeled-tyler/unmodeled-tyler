...
Currently, I'm building Vessel Browser - a web browser designed for harnesses such as Hermes Agent or OpenClaw with support for BYOK API providers. Vessel Browser is a living project, and strives to center the browsing experience around the agent rather than the human. Through this, the agent curates a web browsing experience specifically for the user with the context and information built over time in Hermes Agent or OpenClaw. Currently, Vessel Browser is only available on Linux.
